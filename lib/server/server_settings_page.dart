      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildApiEndpoint('GET', '/api/hosts/{fileId}', AppLocalizations.of(context)!.get_specific_hosts_file),
            _buildApiEndpoint('GET', '/api/hosts/{fileId}/history', AppLocalizations.of(context)!.get_hosts_file_history),
            _buildApiEndpoint('GET', '/api/hosts/{fileId}/history/{historyId}', AppLocalizations.of(context)!.get_specific_history_content),
          ],
        ),
      ),
    );
