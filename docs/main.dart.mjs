...
_1797: (handle) => clearTimeout(handle),
_1798: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1799: (handle) => clearInterval(handle),
_1800: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1801: () => Date.now(),
_1820: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1820(f,arguments.length,x0) }),
_1822: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1823: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
...
_1852: (x0,x1) => x0.test(x1),
_1853: (x0,x1) => x0.exec(x1),
_1854: (x0,x1) => x0.exec(x1),
_1855: x0 => x0.pop(),
_1859: (x0,x1,x2) => x0[x1] = x2,
_1861: o => o === undefined,
_1862: o => typeof o === 'boolean',
_1863: o => typeof o === 'number',
_1865: o => typeof o === 'string',
_1868: o => o instanceof Int8Array,
_1869: o => o instanceof Uint8Array,
_1870: o => o instanceof Uint8ClampedArray,
_1871: o => o instanceof Int16Array,
_1872: o => o instanceof Uint16Array,
_1873: o => o instanceof Int32Array,
_1874: o => o instanceof Uint32Array,
_1875: o => o instanceof Float32Array,
_1876: o => o instanceof Float64Array,
_1877: o => o instanceof ArrayBuffer,
_1878: o => o instanceof DataView,
_1879: o => o instanceof Array,
...
_1889: o => o.length,
_1892: (o, i) => o[i],
_1893: f => f.dartFunction,
_1894: l => arrayFromDartList(Int8Array, l),
_1895: (data, length) => {
...
_1896: l => arrayFromDartList(Uint8ClampedArray, l),
_1897: l => arrayFromDartList(Int16Array, l),
_1898: l => arrayFromDartList(Uint16Array, l),
_1899: l => arrayFromDartList(Int32Array, l),
_1900: l => arrayFromDartList(Uint32Array, l),
_1901: l => arrayFromDartList(Float32Array, l),
_1902: l => arrayFromDartList(Float64Array, l),
_1903: (data, length) => {
...
_1930: x0 => x0.flags,
_1931: x0 => x0.multiline,
_1932: x0 => x0.ignoreCase,
_1933: x0 => x0.unicode,
_1934: x0 => x0.dotAll,
_1935: (x0,x1) => x0.lastIndex = x1,
_2104: (x0,x1) => x0.draggable = x1,
_2120: x0 => x0.style,
_3052: (x0,x1) => x0.accept = x1,
_3066: x0 => x0.files,
_3092: (x0,x1) => x0.multiple = x1,
_3110: (x0,x1) => x0.type = x1,
_3852: () => globalThis.window,
_4182: x0 => x0.localStorage,
_4529: x0 => x0.length,
_6624: x0 => x0.firstChild,
_6635: () => globalThis.document,
_7079: (x0,x1) => x0.id = x1,
_7106: x0 => x0.children,
_8648: x0 => x0.size,
_8656: x0 => x0.name,
_8663: x0 => x0.length,
_8674: x0 => x0.result,
_11623: (x0,x1) => x0.display = x1
    };
